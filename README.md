...
Review one endpoint’s CORS response for an explicit origin.
...
Open <http://127.0.0.1:8090> in a browser. For CLI-capable tools, run `python3 app.py --help` to see the positional form.
